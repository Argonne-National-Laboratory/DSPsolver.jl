...
function setBoolPtrParam(name::AbstractString, size::Integer, value::Array{Bool,1})
	@dsp_ccall("setBoolPtrParam", Void, (Ptr{Void}, Ptr{UInt8}, Cint, Ptr{Cuchar}), 
		env.p, name, convert(Cint, size), convert(Vector{Cuchar}, value))
end
...
function setIntPtrParam(name::AbstractString, size::Integer, value::Array{Int,1})
	@dsp_ccall("setIntPtrParam", Void, (Ptr{Void}, Ptr{UInt8}, Cint, Ptr{Cint}), 
		env.p, name, convert(Cint, size), convert(Vector{Cint}, value))
end
